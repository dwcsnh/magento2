...
(1,1,'ff6ec50107e51d7308ff45f2de32b82a6b1d92471e1a1ae95c054f23af6fbc53:tsO6SEQshu1pMi3n8VMZWbwbOjyNqvIg:3_32_2_67108864',0,1729665176);
...
(1,'john','smith','john.smith@gmail.com','john.smith','ff6ec50107e51d7308ff45f2de32b82a6b1d92471e1a1ae95c054f23af6fbc53:tsO6SEQshu1pMi3n8VMZWbwbOjyNqvIg:3_32_2_67108864','2024-10-23 06:32:56','2024-10-23 06:32:56',NULL,0,0,1,NULL,NULL,NULL,'en_US',0,NULL,NULL);
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='Admin User sessions table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(1,4,'2024-10-23 06:32:56','Disable Notice','To improve performance, collecting statistics for the Magento Report module is disabled by default. \nYou can enable it in System Config.','',0,0);
...
(1,3,0,'2024-10-23 06:32:55','2024-10-23 06:32:55','1',0,0,1),
(2,3,1,'2024-10-23 06:32:55','2024-10-23 06:32:55','1/2',1,1,0);
...
CREATE TABLE `catalog_product_attribute_cl` (
  ...
  `entity_id` int(10) unsigned NOT NULL DEFAULT 0 COMMENT 'Entity ID',
  PRIMARY KEY (`version_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='catalog_product_attribute_cl';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `catalog_product_category_cl` (
  ...
  `entity_id` int(10) unsigned NOT NULL DEFAULT 0 COMMENT 'Entity ID',
  PRIMARY KEY (`version_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='catalog_product_category_cl';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `catalog_product_price_cl` (
  ...
  `entity_id` int(10) unsigned NOT NULL DEFAULT 0 COMMENT 'Entity ID',
  PRIMARY KEY (`version_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='catalog_product_price_cl';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cataloginventory_stock_cl` (
  ...
  `entity_id` int(10) unsigned NOT NULL DEFAULT 0 COMMENT 'Entity ID',
  PRIMARY KEY (`version_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='cataloginventory_stock_cl';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `catalogrule_product_cl` (
  ...
  `entity_id` int(10) unsigned NOT NULL DEFAULT 0 COMMENT 'Entity ID',
  PRIMARY KEY (`version_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='catalogrule_product_cl';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `catalogrule_rule_cl` (
  ...
  `entity_id` int(10) unsigned NOT NULL DEFAULT 0 COMMENT 'Entity ID',
  PRIMARY KEY (`version_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='catalogrule_rule_cl';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `catalogsearch_fulltext_cl` (
  ...
  `entity_id` int(10) unsigned NOT NULL DEFAULT 0 COMMENT 'Entity ID',
  PRIMARY KEY (`version_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='catalogsearch_fulltext_cl';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(1,'default',0,'catalog/search/engine','opensearch','2024-10-23 06:32:53'),
(2,'default',0,'catalog/search/opensearch_server_hostname','opensearch','2024-10-23 06:32:53'),
(3,'default',0,'catalog/search/opensearch_server_port','9200','2024-10-23 06:32:53'),
(4,'default',0,'web/seo/use_rewrites','1','2024-10-23 06:32:53'),
(5,'default',0,'web/unsecure/base_url','https://magneto.test/','2024-10-23 06:32:53'),
(6,'default',0,'web/secure/base_url','https://magneto.test/','2024-10-23 06:32:53'),
(7,'default',0,'general/locale/code','en_US','2024-10-23 06:32:53'),
(8,'default',0,'general/locale/timezone','America/New_York','2024-10-23 06:32:53'),
(9,'default',0,'currency/options/base','USD','2024-10-23 06:32:53'),
(10,'default',0,'currency/options/default','USD','2024-10-23 06:32:53'),
(11,'default',0,'currency/options/allow','USD','2024-10-23 06:32:53'),
(12,'default',0,'general/region/display_all','1','2024-10-23 06:32:53'),
(13,'default',0,'general/region/state_required','AL,AR,AU,BG,BO,BR,BY,CA,CH,CL,CN,CO,CR,CZ,DK,EC,EE,ES,GR,GY,HR,IN,IS,IT,LT,LV,MX,PE,PL,PT,PY,RO,SE,SR,UA,US,UY,VE','2024-10-23 06:32:54'),
(14,'default',0,'catalog/category/root_id','2','2024-10-23 06:32:55'),
(15,'default',0,'twofactorauth/duo/application_key','i18odH9PkWzNW2dQtA8fNKjWYSW0ntyPPk5m38ZjXY413fEVHoFILUb0R7uuwUrH','2024-10-23 06:32:56'),
(16,'default',0,'analytics/subscription/enabled','1','2024-10-23 06:32:56'),
(17,'default',0,'crontab/default/jobs/analytics_subscribe/schedule/cron_expr','0 * * * *','2024-10-23 06:32:56'),
(18,'default',0,'crontab/default/jobs/analytics_collect_data/schedule/cron_expr','00 02 * * *','2024-10-23 06:32:56'),
(19,'default',0,'msp_securitysuite_recaptcha/frontend/enabled','0','2024-10-23 06:32:56'),
(20,'default',0,'msp_securitysuite_recaptcha/backend/enabled','0','2024-10-23 06:32:56');
...
CREATE TABLE `customer_dummy_cl` (
  ...
  `entity_id` int(10) unsigned NOT NULL DEFAULT 0 COMMENT 'Entity ID',
  PRIMARY KEY (`version_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='customer_dummy_cl';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='Data Export Items UUID References Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `design_config_dummy_cl` (
  ...
  `entity_id` int(10) unsigned NOT NULL DEFAULT 0 COMMENT 'Entity ID',
  PRIMARY KEY (`version_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='design_config_dummy_cl';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1157 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='Directory Country Region';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='Flag';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(1,'analytics_link_attempts_reverse_counter',0,'24','2024-10-23 06:32:56'),
(2,'feed_metadata_salesOrders',0,'{\"lockedBy\":\"full reindex(legacy)(71)\"}','2024-10-23 06:33:18'),
(3,'feed_metadata_salesOrderStatuses',0,'{\"lockedBy\":\"full reindex(legacy)(71)\"}','2024-10-23 06:33:18'),
(4,'feed_metadata_stores',0,'{\"lockedBy\":\"full reindex(legacy)(71)\"}','2024-10-23 06:33:18'),
(5,'config_hash',0,'{\"system\":\"2be88ca4242c76e8253ac62474851065032d6833\"}','2024-10-23 06:33:19');
...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='Indexer State';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(1,'design_config_grid','valid','2024-10-23 06:33:17','58c153152077749e414622377d7ef84b'),
(2,'customer_grid','valid','2024-10-23 06:33:17','088375ae5df35ad4fc21b438bba40d69'),
(3,'catalog_category_product','valid','2024-10-23 06:33:17','efaa2d4c512ef886f441ce15f5ef2203'),
(4,'catalog_product_category','valid','2024-10-23 06:33:17','3fdf3efd2421bf0266624ad90f7233c4'),
(5,'catalogrule_rule','valid','2024-10-23 06:33:18','a1fb54059d4c074f32f8e702406ca4dc'),
(6,'catalog_product_attribute','valid','2024-10-23 06:33:18','298616acc5131315611ef9c1fe331aeb'),
(7,'cataloginventory_stock','valid','2024-10-23 06:33:18','3e686a2e0ec814c2efbecc6851079954'),
(8,'inventory','valid','2024-10-23 06:33:18','688f9cc75d94db85a58e25a3072099d0'),
(9,'catalogrule_product','valid','2024-10-23 06:33:18','7a0d3b077cba3dec75e2bc8ad21fc49d'),
(10,'catalog_product_price','valid','2024-10-23 06:33:18','40e054996555915e0f83882e7809cbb2'),
(11,'catalogsearch_fulltext','valid','2024-10-23 06:33:18','9e976ea8c53cba170397e1acbc607eb0'),
(12,'sales_order_data_exporter','valid','2024-10-23 06:33:18','c327556e644ef50f48d44a142cda915c'),
(13,'sales_order_status_data_exporter','valid','2024-10-23 06:33:18','afcde72322306c8349fe74c0834ba5a4'),
(14,'store_data_exporter','valid','2024-10-23 06:33:18','87d1b22fdc6847c81afac2f20605f4e9');
...
CREATE TABLE `inventory_cl` (
  ...
  `entity_id` int(10) unsigned NOT NULL DEFAULT 0 COMMENT 'Entity ID',
  PRIMARY KEY (`version_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='inventory_cl';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='View State';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(1,'sales_order_data_exporter','enabled','idle','2024-10-23 06:33:18',0),
(2,'sales_order_status_data_exporter','enabled','idle','2024-10-23 06:33:18',12),
(3,'store_data_exporter','enabled','idle','2024-10-23 06:33:18',2),
(4,'design_config_dummy','enabled','idle','2024-10-23 06:33:17',0),
(5,'customer_dummy','enabled','idle','2024-10-23 06:33:17',0),
(6,'catalog_category_product','enabled','idle','2024-10-23 06:33:17',0),
(7,'catalog_product_category','enabled','idle','2024-10-23 06:33:17',0),
(8,'catalogrule_rule','enabled','idle','2024-10-23 06:33:18',0),
(9,'catalog_product_attribute','enabled','idle','2024-10-23 06:33:18',0),
(10,'cataloginventory_stock','enabled','idle','2024-10-23 06:33:18',0),
(11,'inventory','enabled','idle','2024-10-23 06:33:18',0),
(12,'catalogrule_product','enabled','idle','2024-10-23 06:33:18',0),
(13,'catalog_product_price','enabled','idle','2024-10-23 06:33:18',0),
(14,'catalogsearch_fulltext','enabled','idle','2024-10-23 06:33:18',0);
...
(121,'Magento\\Sales\\Setup\\Patch\\Data\\InstallOrderStatusesAndInitialSalesConfig'),
(122,'Magento\\Sales\\Setup\\Patch\\Data\\UpdateEntityTypes'),
(123,'Magento\\Sales\\Setup\\Patch\\Data\\ConvertSerializedDataToJson'),
(124,'Magento\\Sales\\Setup\\Patch\\Data\\FillQuoteAddressIdInSalesOrderAddress'),
(125,'Magento\\Sales\\Setup\\Patch\\Data\\UpdateEntityTypeModelForInvoice'),
(126,'Magento\\Sales\\Setup\\Patch\\Data\\WishlistDataCleanUp'),
(127,'Magento\\Checkout\\Setup\\Patch\\Data\\PrepareInitialCheckoutConfiguration'),
(128,'Magento\\Widget\\Setup\\Patch\\Data\\UpgradeModelInstanceClassAliases'),
(129,'Magento\\Widget\\Setup\\Patch\\Data\\ConvertSerializedData'),
(130,'Magento\\Analytics\\Setup\\Patch\\Data\\PrepareInitialConfig'),
(131,'Magento\\Analytics\\Setup\\Patch\\Data\\ActivateDataCollection'),
(132,'Magento\\Downloadable\\Setup\\Patch\\Data\\AddDownloadableHostsConfig'),
(133,'Magento\\Downloadable\\Setup\\Patch\\Data\\InstallDownloadableAttributes'),
(134,'Magento\\Downloadable\\Setup\\Patch\\Data\\UpdateLinksExistDefaultAttributeValue'),
(135,'Magento\\Newsletter\\Setup\\Patch\\Data\\FlagLegacyTemplates'),
(136,'Magento\\Dhl\\Setup\\Patch\\Data\\PrepareShipmentDays'),
(137,'Magento\\Bundle\\Setup\\Patch\\Data\\ApplyAttributesUpdate'),
(138,'Magento\\Bundle\\Setup\\Patch\\Data\\UpdateBundleRelatedEntityTypes'),
(139,'Magento\\Elasticsearch\\Setup\\Patch\\Data\\InvalidateIndex'),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='Payment Services Order Feed Storage';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `payment_services_order_status_data_prod_submitted_hash` (
  ...
  `submitted_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp() COMMENT 'Submitted At',
  PRIMARY KEY (`identifier`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='Payment Services Order Status Feed Storage';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `payment_services_store_data_production_submitted_hash` (
  ...
  `submitted_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp() COMMENT 'Submitted At',
  PRIMARY KEY (`identifier`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='Payment Services Store Feed Storage';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='Table storing unique queues';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='Sales Order Statuses Feed Storage';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sales_data_exporter_order_statuses` VALUES
('canceled','{\"status\":\"canceled\",\"label\":\"Canceled\"}','2024-10-23 06:33:18'),
('closed','{\"status\":\"closed\",\"label\":\"Closed\"}','2024-10-23 06:33:18'),
('complete','{\"status\":\"complete\",\"label\":\"Complete\"}','2024-10-23 06:33:18'),
('fraud','{\"status\":\"fraud\",\"label\":\"Suspected Fraud\"}','2024-10-23 06:33:18'),
('holded','{\"status\":\"holded\",\"label\":\"On Hold\"}','2024-10-23 06:33:18'),
('payment_review','{\"status\":\"payment_review\",\"label\":\"Payment Review\"}','2024-10-23 06:33:18'),
('paypal_canceled_reversal','{\"status\":\"paypal_canceled_reversal\",\"label\":\"PayPal Canceled Reversal\"}','2024-10-23 06:33:18'),
('paypal_reversed','{\"status\":\"paypal_reversed\",\"label\":\"PayPal Reversed\"}','2024-10-23 06:33:18'),
('pending','{\"status\":\"pending\",\"label\":\"Pending\"}','2024-10-23 06:33:18'),
('pending_payment','{\"status\":\"pending_payment\",\"label\":\"Pending Payment\"}','2024-10-23 06:33:18'),
('pending_paypal','{\"status\":\"pending_paypal\",\"label\":\"Pending PayPal\"}','2024-10-23 06:33:18'),
('processing','{\"status\":\"processing\",\"label\":\"Processing\"}','2024-10-23 06:33:18');
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='sales_data_exporter_order_statuses_index_batches';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sales_data_exporter_order_statuses_index_batches` VALUES
(1,'canceled'),
(1,'closed'),
(1,'complete'),
(1,'fraud'),
...
CREATE TABLE `sales_data_exporter_order_statuses_index_sequence` (
  ...
  PRIMARY KEY (`i`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='sales_data_exporter_order_statuses_index_sequence';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sales_data_exporter_order_statuses_index_sequence` VALUES
(1),
(2);
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='Sales Orders Feed Storage';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='sales_data_exporter_orders_index_batches';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sales_data_exporter_orders_index_sequence` (
  `i` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Auto Increment ID',
  PRIMARY KEY (`i`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='sales_data_exporter_orders_index_sequence';
/*!40101 SET character_set_client = @saved_cs_client */;
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=CURRENT_USER*/ /*!50003 TRIGGER trg_sales_order_after_insert AFTER INSERT ON sales_order FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=CURRENT_USER*/ /*!50003 TRIGGER trg_sales_order_after_update AFTER UPDATE ON sales_order FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=CURRENT_USER*/ /*!50003 TRIGGER trg_sales_order_after_delete AFTER DELETE ON sales_order FOR EACH ROW
BEGIN
...
CREATE TABLE `sales_order_data_exporter_cl` (
  ...
  `entity_id` int(10) unsigned NOT NULL DEFAULT 0 COMMENT 'Entity ID',
  PRIMARY KEY (`version_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='sales_order_data_exporter_cl';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=CURRENT_USER*/ /*!50003 TRIGGER trg_sales_order_item_after_insert AFTER INSERT ON sales_order_item FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=CURRENT_USER*/ /*!50003 TRIGGER trg_sales_order_item_after_update AFTER UPDATE ON sales_order_item FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=CURRENT_USER*/ /*!50003 TRIGGER trg_sales_order_item_after_delete AFTER DELETE ON sales_order_item FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=CURRENT_USER*/ /*!50003 TRIGGER trg_sales_order_status_after_insert AFTER INSERT ON sales_order_status FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=CURRENT_USER*/ /*!50003 TRIGGER trg_sales_order_status_after_update AFTER UPDATE ON sales_order_status FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=CURRENT_USER*/ /*!50003 TRIGGER trg_sales_order_status_after_delete AFTER DELETE ON sales_order_status FOR EACH ROW
BEGIN
...
CREATE TABLE `sales_order_status_data_exporter_cl` (
  ...
  PRIMARY KEY (`version_id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='sales_order_status_data_exporter_cl';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=CURRENT_USER*/ /*!50003 TRIGGER trg_sales_payment_transaction_after_insert AFTER INSERT ON sales_payment_transaction FOR EACH ROW
BEGIN
INSERT IGNORE INTO `sales_order_data_exporter_cl` (`entity_id`) VALUES (NEW.`order_id`);
END */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=CURRENT_USER*/ /*!50003 TRIGGER trg_sales_payment_transaction_after_update AFTER UPDATE ON sales_payment_transaction FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=CURRENT_USER*/ /*!50003 TRIGGER trg_sales_payment_transaction_after_delete AFTER DELETE ON sales_payment_transaction FOR EACH ROW
BEGIN
INSERT IGNORE INTO `sales_order_data_exporter_cl` (`entity_id`) VALUES (OLD.`order_id`);
END */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=CURRENT_USER*/ /*!50003 TRIGGER trg_store_after_insert AFTER INSERT ON store FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=CURRENT_USER*/ /*!50003 TRIGGER trg_store_after_update AFTER UPDATE ON store FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=CURRENT_USER*/ /*!50003 TRIGGER trg_store_after_delete AFTER DELETE ON store FOR EACH ROW
BEGIN
...
CREATE TABLE `store_data_exporter_cl` (
  ...
  `entity_id` int(10) unsigned NOT NULL DEFAULT 0 COMMENT 'Entity ID',
  PRIMARY KEY (`version_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='store_data_exporter_cl';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=CURRENT_USER*/ /*!50003 TRIGGER trg_store_group_after_insert AFTER INSERT ON store_group FOR EACH ROW
BEGIN
INSERT IGNORE INTO `store_data_exporter_cl` (`entity_id`) VALUES (NEW.`website_id`);
END */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=CURRENT_USER*/ /*!50003 TRIGGER trg_store_group_after_update AFTER UPDATE ON store_group FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=CURRENT_USER*/ /*!50003 TRIGGER trg_store_group_after_delete AFTER DELETE ON store_group FOR EACH ROW
BEGIN
INSERT IGNORE INTO `store_data_exporter_cl` (`entity_id`) VALUES (OLD.`website_id`);
END */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=CURRENT_USER*/ /*!50003 TRIGGER trg_store_website_after_insert AFTER INSERT ON store_website FOR EACH ROW
BEGIN
INSERT IGNORE INTO `store_data_exporter_cl` (`entity_id`) VALUES (NEW.`website_id`);
END */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=CURRENT_USER*/ /*!50003 TRIGGER trg_store_website_after_update AFTER UPDATE ON store_website FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=CURRENT_USER*/ /*!50003 TRIGGER trg_store_website_after_delete AFTER DELETE ON store_website FOR EACH ROW
BEGIN
INSERT IGNORE INTO `store_data_exporter_cl` (`entity_id`) VALUES (OLD.`website_id`);
END */;;
DELIMITER ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='Stores Feed Storage';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `stores_data_exporter` VALUES
(1,'{\"store_view_id\":\"1\",\"store_id\":1,\"website_id\":1,\"store_view_name\":\"Default Store View\",\"store_name\":\"Main Website Store\",\"website_name\":\"Main Website\"}','2024-10-23 06:33:18');
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='stores_data_exporter_index_batches';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `stores_data_exporter_index_batches` VALUES
(1,1);
...
CREATE TABLE `stores_data_exporter_index_sequence` (
  `i` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Auto Increment ID',
  PRIMARY KEY (`i`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='stores_data_exporter_index_sequence';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `stores_data_exporter_index_sequence` VALUES
(1),
(2);
...
(1,NULL,'Magento/blank','Magento Blank','preview_image_671898971245a.jpeg',0,'frontend',0,'Magento/blank'),
(2,NULL,'Magento/backend','Magento 2 backend',NULL,0,'adminhtml',0,'Magento/backend'),
(3,1,'Magento/luma','Magento Luma','preview_image_671898971b8c9.jpeg',0,'frontend',0,'Magento/luma');
...
-- Dump completed on 2024-10-23  6:38:43
