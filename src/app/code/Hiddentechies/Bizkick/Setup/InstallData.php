...
class InstallData implements InstallDataInterface
{
    ...
    /**
     * Executor for setup operations
     *
     * @var Setup\SampleData\Executor
     */
    private $executor; // Declare the $executor property
    ...
    public function __construct(EavSetupFactory $eavSetupFactory, Setup\SampleData\Executor $executor, Installer $installer)
    {
        ...
        $this->executor = $executor;  // Initialize $executor
    ...
    public function install(ModuleDataSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        // Adding the custom attribute for product
